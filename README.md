# CARP Planner v1.1.2.1

**Computed Air Release Point Planning Tool for Microsoft Flight Simulator**

CARP Planner computes the release point for Container Delivery System (CDS) paradrop missions using the procedures defined in AFMAN 11-231. Enter your drop zone details, fetch real-world weather data, and the tool calculates where to release your cargo so it lands on the Point of Impact.
...
2. Select your **aircraft**, **airspeed**, **drop altitude**, and **parachute**
3. Click **FETCH WEATHER** to retrieve current or forecast wind data
4. Click **COMPUTE CARP** to calculate the release point
5. Use the **tactical map** and **steering compass** to plan your run
6. Click **EXPORT** to save a printable HTML data card

---

## Key Features

- Full AF Form 4018 CARP computation (all 35 items)
- Real-world weather from Open-Meteo with forecast support (Time on Target)
- Tactical map with pan, zoom, and cosine-corrected projection
...
| Scroll Wheel | Zoom tactical map |
